...
public class BachhhInappCreator : EditorWindow
{
    ...
    {
        GetWindow<BachhhInappCreator>("Bachhh IAP Creator");
    ...
    private void OnGUI()
    {
        _iapConfig = BachhhTools.GetIapConfig();
        ...
        if (GUILayout.Button("Create"))
        {
            ...
            AddInstanceToList();
            if (EditorUtility.DisplayDialog("Bachhh Notification", "Product created successfully!", "Nice!"))
            {
                Repaint();
                Close();
            }
