...
public class BachhhPanelCreator : EditorWindow
{
    private const string TemplatePath = "Assets/BachhhStudioSDK/Scripts/Templates/Template1.txt";
    ...
    {
        get => PlayerPrefs.GetInt("BachhhPanelCreatorIsStartedCreateScript") == 1;

        set => PlayerPrefs.SetInt("BachhhPanelCreatorIsStartedCreateScript", value ? 1 : 0);
    }

    private static bool IsWaitingForCreateScript
    {
        get => PlayerPrefs.GetInt("BachhhPanelCreatorIsWaitingForCreateScript") == 1;

        set => PlayerPrefs.SetInt("BachhhPanelCreatorIsWaitingForCreateScript", value ? 1 : 0);
    }

    private static bool IsDone
    {
        get => PlayerPrefs.GetInt("BachhhPanelCreatorIsDone") == 1;

        set => PlayerPrefs.SetInt("BachhhPanelCreatorIsDone", value ? 1 : 0);
    }
    ...
    {
        GetWindow<BachhhPanelCreator>("HyperCat UI Panel Creator");
    }
    ...
    private void OnGUI()
    {
        _uiConfig = BachhhTools.GetUiConfig();
