...
public class GameManager : Singleton<GameManager>
{
    ...
    public BachhhGameSetting gameSetting;
    ...
    {
        gameSetting = BachhhTools.GetGameSetting();
    }
#endif
    ...
    protected override void Awake()
    {
        ...
        IronSourceAdQuality.Initialize(GameManager.Instance.gameSetting.androidAppKey);
    }
