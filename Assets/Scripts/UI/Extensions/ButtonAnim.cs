...
[RequireComponent(typeof(BachhhButton), typeof(CanvasGroup))]
public class ButtonAnim : BachhhMonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    #region Enums
    ...
    private BachhhButton _hcBtn;
    private CanvasGroup _canvasGroup;
    
    private void Reset()
    {
        _hcBtn = GetComponent<BachhhButton>();
